...
export function EyeIcon({ className = "w-6 h-6", ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export function EyeOffIcon({ className = "w-6 h-6", ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export function GoogleIcon({ className = "w-6 h-6", ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export function GithubIcon({ className = "w-6 h-6", ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M12 1.27c-5.93 0-10.73 4.8-10.73 10.73 0 4.75 3.08 8.77 7.35 10.2.54.1.73-.23.73-.52 0-.25-.01-.93-.01-1.83-2.98.65-3.61-1.44-3.61-1.44-.49-1.24-1.19-1.57-1.19-1.57-.97-.66.07-.65.07-.65 1.07.08 1.64 1.1 1.64 1.1.95 1.63 2.5 1.16 3.11.89.1-.69.37-1.16.67-1.43-2.38-.27-4.88-1.19-4.88-5.3 0-1.17.42-2.13 1.1-2.88-.11-.27-.48-1.36.1-2.84 0 0 .9-.29 2.94 1.1a10.22 10.22 0 0 1 5.37 0c2.04-1.39 2.94-1.1 2.94-1.1.58 1.48.21 2.57.1 2.84.69.75 1.1 1.71 1.1 2.88 0 4.12-2.51 5.02-4.9 5.29.38.33.73.98.73 1.97 0 1.42-.01 2.57-.01 2.92 0 .29.19.63.74.52 4.27-1.43 7.35-5.45 7.35-10.2 0-5.93-4.8-10.73-10.73-10.73z" fill="currentColor" />
    </svg>
  )
}

export function MailIcon({ className = "w-6 h-6", ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export function AppleIcon({ className = "w-6 h-6", ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M17.057 10.78c-.045-2.23 1.83-3.3 1.914-3.352-1.04-1.517-2.653-1.723-3.223-1.747-1.36-.14-2.656.802-3.346.802-.69 0-1.76-.784-2.9-.763-1.5.022-2.883.872-3.655 2.215-1.56 2.71-.4 6.726 1.117 8.916.742 1.07 1.623 2.27 2.785 2.227 1.12-.043 1.543-.72 2.9-.72 1.355 0 1.737.72 2.92.697 1.202-.02 1.965-1.083 2.702-2.16.852-1.244 1.203-2.448 1.223-2.51-.026-.01-2.34-.898-2.367-3.566zM14.53 4.568c.61-.74 1.02-1.768.907-2.788-.877.035-1.94.585-2.57 1.32-.563.653-1.055 1.69-.924 2.69.977.076 1.977-.482 2.587-1.222z" />
    </svg>
  )
}

export function ShieldCheckIcon({ className = "w-6 h-6", ...props }: SVGProps<SVGSVGElement>) {
  return (
...
export function UserIcon({ className = "w-6 h-6", ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
